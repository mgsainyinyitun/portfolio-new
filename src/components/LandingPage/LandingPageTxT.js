export const TEXT = {
    ...
    MYANMAR: {
        NAME: "စိုင်းညီညီထွန်း",
        SHORT: "DEVELOPER တစ်ယောက်အကြောင်း",
        MESSAGE: {
            P1: "ကျွန်တော်ရဲ့ portfoliao မှ နွေးထွေးစွာ ကြိုဆိုပါတယ်။",
    ...
    JAPANESE: {
        ...
        MESSAGE: {
            P1: "私のポートフォリオへようこそ。",
            P2: "僕は工科大学（マンダーレー）に エレクトロニクス 専門で 卒業しました。大学に勉強した時に プログラミング は僕の　好きな科目です。僕はソフトウェア開発  とWebプログラミング にとても興味があります。",
            P3: "未来に上手な開発者になると決めています。",
        },
    }

}

// 僕は工科大学（マンダーレー）に エレクトロニクス 専門で 卒業しました。
// 大学に勉強した時に プログラミング は僕の　好きな科目です。
// 僕はソフトウェア開発  とWebプログラミング にとても興味があります。
// 未来に上手な開発者になると決めています。

// 全ての プロジェクトは 僕たちの 習う、問題をチャレンジ、開発 と再開発　さかいは機会です。
